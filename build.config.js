...
module.exports = {
  ...
  vendor_files: {
    js: [
      ...
      'vendor/leaflet-tooltip/leaflet-tooltip.js',
      'vendor/leaflet/dist/images/marker-icon.png',
      'vendor/leaflet/dist/images/marker-shadow.png',
      'vendor/ngFx/dist/ngFxBundle.js',
      'vendor/svg-loaders/svg-loaders/circles.svg'
    ],
    css: [
      'vendor/leaflet/dist/leaflet.css',
      'vendor/leaflet-tooltip/leaflet-tooltip.css',
    ],
    assets: [
    ],
    leaflet_images: [
      'vendor/leaflet/dist/images/*.png'
    ]
  },
};
